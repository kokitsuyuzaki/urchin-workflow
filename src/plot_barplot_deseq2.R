...
df <- data.frame(
    ...
    No_DEGs=c(
        nrow(deg_11h[which(deg_11h$log2FoldChange > 0), ]),
        nrow(deg_11h[which(deg_11h$log2FoldChange < 0), ]),
        nrow(deg_14h[which(deg_14h$log2FoldChange > 0), ]),
        nrow(deg_14h[which(deg_14h$log2FoldChange < 0), ]),
        nrow(deg_18h[which(deg_18h$log2FoldChange > 0), ]),
        nrow(deg_18h[which(deg_18h$log2FoldChange < 0), ]),
        nrow(deg_24h[which(deg_24h$log2FoldChange > 0), ]),
        nrow(deg_24h[which(deg_24h$log2FoldChange < 0), ])))
